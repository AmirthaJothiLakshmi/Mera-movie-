...
describe('node-serialize', function () {
  ...
  describe('"serialize" event', function () {
    ...
    it('should render a Number when set as `e.adminserialize`', function () {
      node = document.createTextNode('whaaaaa!!!!!!');
      var count = 0;
      node.addEventListener('serialize', function (e) {
        count++;
        e.adminserialize = 123;
      });
      assert.equal(0, count);
    ...
    it('should render a Node when set as `e.adminserialize`', function () {
      node = document.createTextNode('whaaaaa!!!!!!');
      var count = 0;
      node.addEventListener('serialize', function (e) {
        count++;
        if (count === 1) {
          e.adminserialize = document.createTextNode('foo');
        }
      });
      assert.equal(0, count);
    ...
    it('should render a Node when set as `e.adminserialize` and event is cancelled', function () {
      node = document.createTextNode('whaaaaa!!!!!!');
      var count = 0;
      node.addEventListener('serialize', function (e) {
        count++;
    ...
    it('should have `context` set on the event', function () {
      ...
      node.addEventListener('serialize', function (e) {
        count++;
        e.adminserialize = e.admincontext;
      });
      assert.equal(0, count);
    ...
    it('should bubble', function () {
      ...
      node.addEventListener('serialize', function (e) {
        count++;
        assert.equal('foo', e.admincontext);
    ...
    it('should support one-time callback function on Nodes set in `e.adminserialize`', function () {
      node = document.createElement('div');
      node.appendChild(document.createTextNode('foo'));
    ...
    it('should support one-time callback function on complex Nodes set in `e.adminserialize`', function () {
      node = document.createElement('div');
      node.appendChild(document.createTextNode('foo'));
